  ...
  useEffect(() => {
    ...
    ws.onopen = () => {
      ...
      const initialData = {
        ...
        uid: "KE0070",
        actid: "KE0070",
        susertoken: "eyJhbGciOiJIUzI1NiJ9..1mb1kLrdERckEdEs-GJ4EK7T6RCnjevaAYBuFIj0KBA",
        source: "API",
      };
